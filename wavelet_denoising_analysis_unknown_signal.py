...
from waveletfuncs import getAllWavelets, getMaxLevel, SuccessRatio, PSNR, getFilters, denoise, dwt, idwt, threshold, multires, dwt2, idwt2, SNR, SnNR, getScaledDecompositionLevels, getHurstThresholds
...
for i, filename in enumerate(sorted(os.listdir(sound_file_path))):
    ...
    # if filename=='34.wav':
        ...
        # for technique in ['multi_res','scaled_res']:
            ...
            # Preservation_Ratio = log(PR_1/PR_2,10)
        ...
        # print('SR: '+str(SR_val)+', SnNR_imp: '+str(SnNR_improvement))
        # plt.show()
